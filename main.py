...
def main():
    ...
    app.add_handler(CallbackQueryHandler(admin.set_recommendations_channel_start, pattern="^admin_set_recommendations_ch$"))
    ...
    set_invite_count_conv = ConversationHandler(
        ...
        states={
            SET_INVITE_COUNT: [MessageHandler(filters.TEXT & ~filters.COMMAND, admin.set_invite_count)]
        },
        fallbacks=[CommandHandler("cancel", admin.cancel)]
    )
    ...
    set_series_ch_conv = ConversationHandler(
        ...
        states={
            SET_SERIES_CH: [MessageHandler(filters.TEXT & ~filters.COMMAND, admin.set_series_channel)]
        },
        fallbacks=[CommandHandler("cancel", admin.cancel)]
    )
    ...
    set_movies_ch_conv = ConversationHandler(
        ...
        states={
            SET_MOVIES_CH: [MessageHandler(filters.TEXT & ~filters.COMMAND, admin.set_movies_channel)]
        },
        fallbacks=[CommandHandler("cancel", admin.cancel)]
    )
    app.add_handler(set_movies_ch_conv)

    set_recommendations_ch_conv = ConversationHandler(
        entry_points=[CallbackQueryHandler(admin.set_recommendations_channel_start, pattern="^admin_set_recommendations_ch$")],
        states={
            SET_RECOMMENDATIONS_CH: [MessageHandler(filters.TEXT & ~filters.COMMAND, admin.set_recommendations_channel)]
        },
        fallbacks=[CommandHandler("cancel", admin.cancel)]
    )
    app.add_handler(set_recommendations_ch_conv)

    funding_conv = ConversationHandler(
        entry_points=[CallbackQueryHandler(admin.funding_start, pattern="^admin_funding$")],
        states={
            FUNDING_CH: [MessageHandler(filters.TEXT & ~filters.COMMAND, admin.funding_get_channel)],
            FUNDING_COUNT: [MessageHandler(filters.TEXT & ~filters.COMMAND, admin.funding_get_count)]
        },
        fallbacks=[CommandHandler("cancel", admin.cancel)]
    )
